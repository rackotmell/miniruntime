...
#define LOG_DEBUG(format, ...)                                                                     \
    miniruntime::logger::Logger::getInstance().log(                                                \
        miniruntime::logger::LogLevel::Debug, std::source_location::current(), format, ##__VA_ARGS__)

#define LOG_INFO(format, ...)                                                                      \
    miniruntime::logger::Logger::getInstance().log(                                                \
        miniruntime::logger::LogLevel::Info, std::source_location::current(), format, ##__VA_ARGS__)

#define LOG_WARNING(format, ...)                                                                   \
    miniruntime::logger::Logger::getInstance().log(                                                \
        miniruntime::logger::LogLevel::Warning, std::source_location::current(), format, ##__VA_ARGS__)

#define LOG_ERROR(format, ...)                                                                     \
    miniruntime::logger::Logger::getInstance().log(                                                \
        miniruntime::logger::LogLevel::Error, std::source_location::current(), format, ##__VA_ARGS__)
} // namespace miniruntime::logger